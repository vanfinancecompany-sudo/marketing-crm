...
export function mapDealerKitListing(listing = {}) {
  ...
  return {
    ...
    vehicleCategory: clean(vehicle?.category ?? listing?.category, 200),
    vehicleClass: clean(vehicle?.classification ?? vehicle?.class ?? listing?.classification, 200),
    bodyStyle: clean(vehicle?.body_style, 300),
