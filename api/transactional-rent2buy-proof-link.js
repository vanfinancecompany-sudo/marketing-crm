...
export function renderEmail(payload) {
  ...
  const subject = "Complete your Rent2Buy application – upload your documents";
  const plain = `We’ve received your Rent2Buy application details. To complete your application and allow the team to assess it, please upload the required supporting documents using your personal link below.\n\nYou will need:\n• 3 months’ full bank statements in PDF format\n• 2 proofs of your current address\n• your driving licence\n\n${payload.uploadUrl}\n\nApplication: ${payload.applicationRef}\nVehicle: ${payload.vehicle}\n\nYour personal link expires after seven days. If you need time to find a document, keep the link and return to it, but assessment cannot begin until the required proofs are received.`;
  const html = `<!doctype html><html><body style="margin:0;background:#f2f2ef;font-family:Arial,Helvetica,sans-serif;color:#111114"><table width="100%" cellspacing="0" cellpadding="0" style="padding:26px 12px"><tr><td align="center"><table width="620" cellspacing="0" cellpadding="0" style="width:100%;max-width:620px;background:#fff;border-radius:18px;overflow:hidden;border:1px solid #e1e0dc"><tr><td style="padding:24px 26px;background:#111114;color:#fff"><div style="color:#f4213e;font-size:11px;font-weight:800;letter-spacing:1.4px">RENT2BUY</div><h1 style="margin:10px 0 0;font-size:25px">Complete your Rent2Buy application.</h1></td></tr><tr><td style="padding:26px"><p style="margin:0 0 16px;line-height:1.6">${greeting}</p><p style="margin:0 0 16px;line-height:1.6">We’ve received your application details. The team can assess your Rent2Buy application once the required supporting documents are received.</p><div style="margin:0 0 18px;padding:14px 16px;background:#f7f7f4;border-radius:12px;line-height:1.65"><strong style="display:block;margin-bottom:6px">Please have ready:</strong>3 months’ full bank statements (PDF)<br>2 proofs of your current address<br>Your driving licence</div><a href="${escapeHtml(payload.uploadUrl)}" style="display:block;background:#f4213e;color:#fff;text-decoration:none;text-align:center;font-weight:800;padding:15px 18px;border-radius:12px">Complete my application</a><table width="100%" cellspacing="0" cellpadding="0" style="margin-top:22px;background:#f7f7f4;border-radius:12px"><tr><td style="padding:6px 10px;color:#777;font-size:12px">Application</td><td style="padding:6px 10px;font-weight:800;font-size:12px">${escapeHtml(payload.applicationRef)}</td></tr><tr><td style="padding:6px 10px;color:#777;font-size:12px">Vehicle</td><td style="padding:6px 10px;font-weight:800;font-size:12px">${escapeHtml(payload.vehicle)}</td></tr></table><p style="margin:20px 0 0;color:#777;font-size:12px;line-height:1.6">This is your personal upload link and it expires after seven days. If you need time to find a document, keep the link and return to it. Assessment cannot begin until the required proofs are received.</p></td></tr></table></td></tr></table></body></html>`;
