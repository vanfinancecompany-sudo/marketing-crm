...
export async function runDealerKitAdapterPreviewSmoke() {
  ...
  console.log(JSON.stringify({
    ...
    pageCounts: snapshot.diagnostics.pageCounts,
    rawMappedRecords: snapshot.diagnostics.rawMappedRecords,
    vehicleCount: snapshot.vehicleCount,
    invalidRecordCount: snapshot.diagnostics.invalidRecords.length,
    invalidRecords: snapshot.diagnostics.invalidRecords,
