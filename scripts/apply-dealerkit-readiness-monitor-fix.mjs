...
patch(
  ...
  'return fetchStableDealerKitStockSnapshot({ environment, fetchImplementation, allowPartial, stabilityAttempts });',
  "provider stable partial-read passthrough",
  'fetchStableDealerKitStockSnapshot({ environment, fetchImplementation, allowPartial, stabilityAttempts })'
);
