...
function CampaignWizard({ form, setForm, step, setStep, audienceRules, setAudienceRules, audiencePreview, setAudiencePreview, audienceDirty, setAudienceDirty, audienceLoading, audienceError, audienceOptions, createdCampaign, creating, createError, batchSizeMode, customBatchSize, onPreviewAudience, onCreate, onCancel, onOpenCampaign }) {
...
export default function MarketingCentrePage() {
  ...
  function resetWizard(channel = "email") {
    setWizardStep(0);
    setWizardForm({ ...EMPTY_CAMPAIGN_FORM, channel });
    setWizardRules(DEFAULT_AUDIENCE_RULES);
