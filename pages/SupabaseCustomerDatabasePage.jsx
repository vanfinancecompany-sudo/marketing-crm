...
export default function SupabaseCustomerDatabasePage() {
  ...
  function handleLockCustomerDatabase() { clearStoredCustomerDatabaseApiKey(); setApiKeyReady(false); setContacts([]); setStats(EMPTY_STATS); setImportHistory([]); setImportReports({ rejectedRows: [], duplicateRows: [], possibleDuplicates: [] }); setSelectedIds([]); setError(""); }
