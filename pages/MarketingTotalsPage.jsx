...
export default function MarketingTotalsPage({ onNavigate }) {
  ...
  return <div className="page-stack marketing-totals-page">
    ...
    {loading ? <section className="panel">Loading totals…</section> : null}
    {result ? <>
