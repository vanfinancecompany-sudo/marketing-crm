...
export const VFC_PRIMARY_SOURCE_KNOWLEDGE = Object.freeze({
  ...
  faqs: Object.freeze([
    ...
    finance("What if there is a problem with my van after delivery?", "Contact VFC's after-sales team directly by email or WhatsApp and send as much detail as possible, ideally photos or video. The team will look to rectify the issue promptly. If workshop attention is needed, a local garage is normally the quickest and most practical route; VFC deals directly with the garage for authorised warranty repairs."),
