...
export function buildGoogleBusinessCaption(vehicle, productKey) {
  const heading = productKey === "rent2buy"
    ? "RENT2BUY VAN AVAILABLE"
    : "VAN FINANCE COMPANY STOCK";
  const relationship = productKey === "rent2buy"
    ? "Available through Rent2Buy Vans from Van Finance Company."
    : "Available now from Van Finance Company.";
...
${relationship}
View full vehicle details, photos and specification using Learn more.`
    .replace(/\n{3,}/g, "\n\n")
    .trim();
}
