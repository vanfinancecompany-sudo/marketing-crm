...
export function rent2BuyPaymentStructure({ termMonths, categories = [] } = {}) {
  ...
  // ordinary vans retain the current 3-rental initial payment and display 36X / 48X monthly payments.
  // pickup/4x4 stock uses 4 rentals upfront followed by 35X / 47X monthly payments.
  return {
    termMonths: term,
    pickup,
