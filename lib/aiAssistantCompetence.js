...
export function isExplicitProductComparison(question, messages = []) {
  ...
  return /\b(compare|comparison|difference|different|versus|vs\.?|both|which (?:option|one)|alternative)\b/.test(text);
}
