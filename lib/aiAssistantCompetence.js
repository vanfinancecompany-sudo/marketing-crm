import { BUSINESS_KNOWLEDGE_SECTION_DEFINITIONS, buildAiPlatformPrompt, normalizeBusinessKnowledgeSections } from "./businessIntelligence.js";
...
export function filterKnowledgeForProduct({ sections = [], articles = [], settings = {} } = {}, productContext, { comparison = false } = {}) {
  ...
  const normalizedSections = normalizeBusinessKnowledgeSections(sections, settings);
