...
function orderedSourceImages(vehicle = {}, decision = {}) {
  ...
  const orderedIds = decision.financeEnabled !== false ? [...productState.finance.includedOrderIds] : [];
  ...
  return {
    ...
    orderedIds,
    primaryId: decision.financeEnabled !== false ? productState.finance.primaryId : productState.rent2buy.primaryId,
  };
}
...
export function buildDealerKitWixMediaPlan({ vehicle = {}, decision = {} } = {}) {
  ...
  const primaryImageId = clean(ordered.primaryId, 300) || null;
