...
const THANKS = /^(?:thanks|thank you|cheers|nice one|brilliant|great|perfect|helpful|that helps|that s useful|that is useful|useful)[!. ]*$/i;
...
const RETURNING = /^(?:back now|i\s*m back|im back|carry on|continue|can i continue|ok continue|okay continue|resume|back to it)$/i;
