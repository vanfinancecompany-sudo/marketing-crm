...
export const PRIORITY_AI_MODEL_DEFAULTS = Object.freeze({
  // Customer-facing Wix assistant: one consistent GPT-6 Sol brain.
  // Reasoning effort, not model hopping, controls speed vs depth in aiAssistantModelRouter.
  wix_fast: "gpt-6-sol",
  wix_main: "gpt-6-sol",
  wix_escalation: "gpt-6-sol",
  // GPT-6 Luna is the low-cost workforce for bounded/background tasks.
  knowledge_topic: "gpt-6-luna",
  knowledge: "gpt-6-luna",
  // Keep the final knowledge quality gate on Sol.
  knowledge_review: "gpt-6-sol",
  editorial: "gpt-6-luna",
  marketing_content: "gpt-6-luna",
  marketing_review: "gpt-6-luna",
  website_intelligence: "gpt-6-luna",
  editorial_automation: "gpt-6-luna",
  competence_bulk: "gpt-6-luna",
});
