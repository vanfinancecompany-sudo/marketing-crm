import { withVfcPrimarySourceKnowledge } from "./vfcPrimarySourceKnowledge.js";
...
export function normalizeBusinessKnowledgeSections(sections = [], settings = {}) {
  ...
  return BUSINESS_KNOWLEDGE_SECTION_DEFINITIONS.map((definition, index) => {
    ...
    return {
      ...
      entries: withVfcPrimarySourceKnowledge(definition.key, cleanEntries(section.entries)),
