...
const BLOCKED_PLACE_TOKENS = new Set([
  ...
  "apply", "application", "qualify", "eligible", "accepted", "finance", "rent2buy", "rent", "buy", "van", "vehicle", "delivery", "deliver",
...
export function extractTolerantPostcode(question) {
  ...
  // Also catch a valid postcode embedded in normal prose when spacing or a hyphen is unusual.
